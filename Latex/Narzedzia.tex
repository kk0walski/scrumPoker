...
\begin{figure}[H]
	\centering\includegraphics[width=.8\textwidth]{img/Microsoft_Project}
...
\begin{figure}[H]
	...
	\caption{Microsoft Project[www.jira.com]}\label{rys:trello}% Źródło rysunku i etykieta przez którą odwołujemy się do rysunku.
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Microsoft Project[www.trello.com/home]}\label{rys:trello}% Źródło rysunku i etykieta przez którą odwołujemy się do rysunku.
\end{figure}
