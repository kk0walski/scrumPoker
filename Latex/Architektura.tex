...
dla którego wartość atrybutu jest zwiększona o jeden \texttt{counter}.
Jeżeli zaś typem akcji jest `DECREMENT' to zwracany jest nowy stan, którego atrybut jest
\texttt{counter} zmniejszony o jeden.
