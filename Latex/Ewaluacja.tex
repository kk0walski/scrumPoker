...
\begin{enumerate}
    \item Będę często korzystał z aplikacji.
    \item Aplikacja jest zbyt skomplikowana.
    \item Aplikacja jest prosta w użyciu.
    \item Będzie niezbędne wparcie techniczne, aby korzystać z aplikacji.
    \item Różne funkcje aplikacji są łatwe w użyciu.
    \item Aplikacja zawiera zbyt wiele niespójności.
    \item Większość użytkowników będzie w stanie opanować aplikację bardzo szybko.
    \item Aplikacja jest kłopotliwa w użytkowaniu.
    \item Czuję się bardzo pewnie korzystając z aplikacji.
    \item Byłem zmuszony opanować wiele rzeczy przed rozpoczęciem pracy z aplikacją.
\end{enumerate}
...
Krok 1. Przyporządkowujemy do każdej odpowiedzi wartości od 0 do 4, zgodnie z poniższym schematem. \newline
\newline
dla pytań 1, 3, 5, 7, 9 przypisuje się poniższą punktację:
\begin{itemize}
...
\end{itemize}
dla pytań 2, 4, 6, 8, 10 punktacja jest następująca:
\begin{itemize}
...
\begin{itemize}
    \item 2. Aplikacja jest zbyt skomplikowana.
    \item 6. Aplikacja zawiera zbyt wiele niespójności.
    \item 8. Aplikacja jest kłopotliwa w użytkowaniu
\end{itemize}
\begin{landscape}
    \begin{table}
