...
class StoryPoint extends Component {
    ...
    submitScore() {
        const { owner, repo, game, story, user } = this.props;
        const { editValue } = this.state;
        console.log("EDIT VALUE: ", editValue)
        if (!isNaN(editValue) && user.uid === game.firebaseOwner) {
    ...
    render() {
        const { story, user, game } = this.props
                ...
                <div className="card-header d-flex justify-content-center">
                    <div className="deck">
                        <div className="card">
                            ...
                            <button type="button" className="btn btn-outline-primary scoreEdit " onClick={this.submitScore}>
                                <FaSave />Save score
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="deck">
                        <div className="card">
                            ...
                            {user.uid === game.firebaseOwner &&
                                <button type="button" className="btn btn-outline-primary scoreEdit" onClick={this.editScore}>
                                    <FaPen />Edit card
                             </button>
                            }
                        </div>
